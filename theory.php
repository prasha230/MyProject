...
<body>
	...
	<div class="shadow-lg p-3 bg-transparent rounded mt-2">
		<h1 class="m-5 text-white">Learn Theory</h1>
			<div class="container shadow-lg p-3 bg-white rounded mt-2">
				<?php
					$api_key = 'AIzaSyDz6bGFofvHiGIxYBWOwdojoTR0N7BWoWg';
					$playlist_id =  'PL74753C01E9345AA0'; 
